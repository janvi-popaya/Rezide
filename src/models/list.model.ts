...
const ListingDetailsSchema = new Schema(
  {
    ...
    office_area: { type: String, enum: Object.values(YesAndNo) }, // or String
    truck_access: { type: String, enum: Object.values(YesAndNo) }, // or String
    access_road_width: String,
    vehicle_height_restrictions: String,
    vehicle_height_inch: String,
    loading_area: { type: String, enum: Object.values(YesAndNo) }, // or String
    lorry_bay_area: { type: String, enum: Object.values(YesAndNo) }, // or String
    ...
    corner_plot: { type: String, enum: Object.values(YesAndNo) }, // or String
    no_of_open_sides: String,
    boundary_wall: Boolean,
    sewage_drainage: String,
    gated_community: { type: String, enum: Object.values(YesAndNo) }, // or String
...
const CommercialDetailsSchema = new Schema(
  {
    ...
    access_notes: String,
    tax_govt_charges_included: { type: String, enum: Object.values(YesAndNo) }, // or String
